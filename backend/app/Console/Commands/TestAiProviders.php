...
class TestAiProviders extends Command
{
    ...
    public function handle(\App\Services\AI\LLMProviderManager $llmManager, \App\Services\RAG\RetrievalService $retrieval)
    {
        $messages = [
        ...
        foreach (['gemini', 'groq', 'ollama'] as $provider) {
            \App\Models\AdminSetting::updateOrCreate(['key' => 'ai_llm_provider'], ['value' => $provider]);
        ...
        \App\Models\AdminSetting::updateOrCreate(['key' => 'ai_embedding_provider'], ['value' => 'gemini']);
        ...
        \App\Models\AdminSetting::updateOrCreate(['key' => 'ai_llm_provider'], ['value' => 'gemini']);
        \App\Models\AdminSetting::updateOrCreate(['key' => 'ai_embedding_provider'], ['value' => 'ollama']);
